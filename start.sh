...
PORT="${PORT:-3610}"
DB_NAME="${PGDATABASE:-clinical_life_sciences_suite}"
DB_HOST="${PGHOST:-127.0.0.1}"

echo "======================================="
echo "      Clinical Life Sciences Suite"
echo "======================================="
echo
...
echo "Starting clinical life sciences suite frontend on http://localhost:$PORT"
echo "Login: admin@clinical-life.local / admin123"
