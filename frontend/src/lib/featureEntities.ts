...
const entitySeeds = [
  ...
  ['literature-review', 'Literature Review Records', 'Oncology biomarker review set', 'In synthesis', 'Unanswered research gap list', 'Evidence Lead', '$0'],
  ['citation-tracker', 'Citation Tracker Records', 'Zotero export cleanup', 'Review', 'Missing DOI follow-up', 'Evidence Librarian', '$0'],
  ['paper-summaries', 'Paper Summary Records', 'Phase II abstract summary batch', 'Generated', 'Methodology quality hold list', 'Medical Writer', '$0'],
  ['evidence-tables', 'Evidence Table Records', 'PICO extraction table', 'Review', 'Low-confidence evidence rows', 'Clinical Reviewer', '$0'],
