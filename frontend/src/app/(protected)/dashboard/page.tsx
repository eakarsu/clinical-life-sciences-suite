...
export default function DashboardPage() {
  return (
    <UnifiedShell
      ...
      title="Clinical Life Sciences Dashboard"
      subtitle="One merged clinical life-sciences view for studies, participants, trial operations, safety, regulatory, data, documents, and AI."
    >
      ...
      <div className="grid columns-2">
        <div className="card stack">
          ...
          <div className="muted">
            This suite removes project-based navigation and groups shared clinical research jobs into one surface.
            Trial operations, safety, regulatory, data management, medical writing, and AI are presented as platform features.
          </div>
